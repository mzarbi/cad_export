...
from zdxf.lldxf.types import tag_type, point_tuple, is_point_code, internal_type, is_pointer_code
from zdxf.lldxf.types import GROUP_MARKERS, HEX_HANDLE_CODES, HANDLE_CODES, BINARY_FLAGS
from zdxf.tools.c23 import escape, ustr
from .reflinks import get_reference_link
from zdxf.sections.sections import KNOWN_SECTIONS
from zdxf.lldxf.tags import CompressedTags
